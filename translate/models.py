...
class ApplicationString(TimeStampMixin):
    ...
    def get_en_translation(self): return ApplicationStringsTranslation.objects.get(
        translation_string=self, language__code='en-US')
    ...
    def get_fr_translation(self): return ApplicationStringsTranslation.objects.get(
        translation_string=self, language__code='fr-CA')
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['translation_string', 'language'], name='unique_translation_string_language')
        ]
...
class AutoTranslationLog(TimeStampMixin):
    ...
    target_type = models.CharField(
        max_length=100, choices=TARGET_TYPE_CHOICES, default=TARGET_TYPE_CHOICES[0][0])
...
class CustomKeyTranslation(TimeStampMixin):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['custom_key', 'language'], name='unique_custom_key_language')
        ]
